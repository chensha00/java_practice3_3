...
//                List<StoreGoods> userList = new ArrayList<>();
                    List<StoreGoods>userList=new ArrayList<StoreGoods>();
                    //驱动获得链接
...
//                userList.add(user);
                    ...
                    request.getRequestDispatcher("StoreGoods.jsp").forward(request, response);
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="know">
                                ...
                                <em style="display: inline;" id="reptorpay" class="margin3">库存:${order.GOODS_NUM} 件</em>
                            </div>
