...
<table border="0">
      <tr>
          ...
          <td width="500px">${payWater.payWaterNumber}</td>
      </tr>
      <tr>
          <td><p>账户名称:</p></td>
      ...
      <tr>
          <td><p>交易时间:</p></td>
          <td>${payWater.transactionTime}<</td>
      </tr>
      <tr>
          <td><p>当前状态:</p></td>
          <td>支付成功</td>
    ...
    <tr>
        ...
        <td><h1 style="font-size: 65px">¥${payWater.transactionAmount}</h1></td>
    </tr>
    <tr>
        <td style="height:50px"><p >距离小目标还有多少？</p></td>
        <td><h1 style="font-size:25px">¥1000000000-${payWater.transactionAmount}</h1></td>
    </tr>
</table>
    </div>
