...
public class OrderInfoDaoImpl implements OrderInfoDao {
    ...
    public Integer saveOrUpdateOrderById(OrderInfo orderInfo, Connection connection, PreparedStatement preparedStatement, DataSourceUtils dataSourceUtils)  throws SQLException {
        ...
        if (orderInfo.getId()==null){
            preparedStatement=connection.prepareStatement("INSERT INTO order_info(ID,ORDER_NUM,ORDER_STATUS,BUYER_USER_ACCOUNT_ID,STORE_ID,GOODS_INFO,GOODS_SUM_MONEY,ORDER_TIME,DELIVER_TIME,SUCCESS_TIME,IS_CANCELLATION)VALUES (DEFAULT,?,?,?,?,?,?,?,?,?,?)", Statement.RETURN_GENERATED_KEYS);
