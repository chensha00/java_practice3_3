...
public interface BuyGoodsDao {
 ...
 //更新商品信息
    ...
    //通过内容查询商品信息
    public  List<BuyGoods> findBuyGoodsByCondtion(Map<String, String> stringObjectMap, Connection connection, PreparedStatement preparedStatement)throws SQLException;;
}
