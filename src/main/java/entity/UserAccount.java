...
public class UserAccount {
     ...
     * @param isDelete
     */
    public UserAccount(Long id, String userAccountName, String userAccountPassWord, String payingPassWord, Date registerTime, Double money, Byte isBuyer, Byte isFreezing, Byte isLost, Byte isDelete) {
        this.id = id;
