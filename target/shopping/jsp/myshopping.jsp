...
<html>
<head>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/myshopping_css.css" type="text/css">
...
<div class="left_div float_left">
    <div class="logo_img">
        <img src="<%=request.getContextPath()%>/images/shoppingLoge.png"/>
    </div>
...
<%--清楚浮动--%>
    ...
    <div class="user_info_div">
            ...
            <h2> ${user.userName}  <span class="user_register_date" > 注册日期： ${user.registerTime}</span></h2>
            ...
            <div>
                <table class="order_info_table" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<%=request.getContextPath()%>\images\vaida.jpg"alt="商品图片">
                        </td>
